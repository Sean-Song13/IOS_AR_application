...
//  AR-Demo
//
//  Created by xinhao.song on 2021/12/4.
//
...
class ScenePersistenceHelper {
    class func saveScene(for arView: MyARView, at persistenceUrl: URL){
    ...
    class func loadScene(for arView: MyARView, with scenePersistenceData: Data){
        ...
        let worldMap: ARWorldMap = {
            do {
                ...
                fatalError("Persistence Error: Unable to unarchive ARWorld from scenepersistenceData: \(error.localizedDescription)")
            }
        }()
